...
class RemoteServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamCall = channel.stream_stream(
                '/easyremote.RemoteService/StreamCall',
                request_serializer=service__pb2.StreamCallFrame.SerializeToString,
                response_deserializer=service__pb2.StreamCallFrame.FromString,
                _registered_method=True)
...
class RemoteServiceServicer(object):
    ...
    def StreamCall(self, request_iterator, context):
        """Bidirectional client streaming execution
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_RemoteServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'StreamCall': grpc.stream_stream_rpc_method_handler(
                    servicer.StreamCall,
                    request_deserializer=service__pb2.StreamCallFrame.FromString,
                    response_serializer=service__pb2.StreamCallFrame.SerializeToString,
            ),
...
class RemoteService(object):
    ...
    def StreamCall(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/easyremote.RemoteService/StreamCall',
            service__pb2.StreamCallFrame.SerializeToString,
            service__pb2.StreamCallFrame.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
