...
SDK_CASES = [
    ...
    (easynet_sdk.ErrorCode.SIGNATURE_DENIED, PermissionDenied, "signature_denied"),
    (easynet_sdk.ErrorCode.POLICY_DENIED, PermissionDenied, "policy_denied"),
    (easynet_sdk.ErrorCode.AUTHORITY_DENIED, PermissionDenied, "authority_denied"),
    ...
    (easynet_sdk.ErrorCode.EXECUTION_FAILED, InternalError, "execution_failed"),
